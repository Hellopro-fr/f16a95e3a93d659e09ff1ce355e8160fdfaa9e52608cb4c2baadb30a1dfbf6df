...
from app.schemas.cleaner.cleaner import BaseCleaner as BaseData, BaseCleanerReponse, ReponseHtml
...
async def clean(datas: list[BaseData]) -> List[BaseCleanerReponse | ReponseHtml]:
